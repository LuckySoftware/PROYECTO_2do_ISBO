...
public class Inicio extends javax.swing.JFrame {
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        try 
        {
            PreparedStatement sentencia = bd.getConnection().prepareStatement("SELECT * FROM jugador WHERE correoElectronico = ? AND userPassword = ?");
            sentencia.setString(1, correoElectronico);
            sentencia.setString(2, userPassword);
            bd.ejecutarSQL(sentencia);
            
            //recorrer el resultado de la consulta
            String nombreCompleto = "";
            while (bd.getResult().next())
            {
                nombreCompleto = bd.getResult().getString("nombreCompleto");
            }
            
            //datos validos
            if (nombreCompleto.isEmpty())
            {
                JOptionPane.showMessageDialog(null, "Error, usuario y/o password incorrecta");
            }
            else
            {
